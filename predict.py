...
# with open('./classsifier.obj', 'rb') as f:
#     clf1 = cPickle.load(f)

with open('./classifier75.obj', 'rb') as f:
    clf2 = cPickle.load(f)
...
print(data.columns)
data.drop(['question1','question2','word_overlap','text1_nostop','text2_nostop','text1_lower','text2_lower','common_words'], axis = 1, inplace=True)
print(data.columns)
